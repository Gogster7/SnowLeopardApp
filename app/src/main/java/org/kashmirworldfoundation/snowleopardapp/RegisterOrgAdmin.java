    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mbRegisterA.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (util.getAgreement(RegisterOrgAdmin.this)){
                    LayoutInflater inflater= LayoutInflater.from(RegisterOrgAdmin.this);
                    View view=inflater.inflate(R.layout.disclaimer_layout, null);


                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(RegisterOrgAdmin.this);
                    alertDialog.setTitle("Terms of Service");
                    alertDialog.setView(view);
                    alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(RegisterOrgAdmin.this,"Agreement needed to register",Toast.LENGTH_LONG).show();
                        }
                    ...
                    alertDialog.setPositiveButton("Agree", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            util.setAgreement(RegisterOrgAdmin.this);
                            registerAdmin();
                        }
                    });
